...
L'hash dell'URL va catturato SUBITO (initializer di useState), prima che
supabase-js lo consumi con detectSessionInUrl: serve per riconoscere i link
scaduti (#error_code=otp_expired). */
export default function AccettaInvito() {
  ...
  const [step, setStep] = useState<Step>(hashError ? "invalid" : "loading");
